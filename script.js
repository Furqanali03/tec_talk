...
const themeModle = document.querySelector('.custimze-theme');
...
//highlight messages bar when message card clicked
...
const closethemeModle = (e) => {
    if(e.target.classList.contains('custimze-theme')){
